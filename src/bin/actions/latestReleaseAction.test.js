...
describe('latestReleaseAction', () => {
  ...
  it('should log the successful action', async () => {
    ...
    sandbox
      .stub(gitInteractions, 'latestRelease')
      .resolves({ name: expectedVersionName });
    ...
    consoleSpy.should.have.been.calledWith(
      `The latest release version for ${repoDetails} is ${expectedVersionName}`
    );
  });
